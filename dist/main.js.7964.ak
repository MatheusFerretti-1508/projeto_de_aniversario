...
document.addEventListener("DOMContentLoaded", function(e) {
    const dataDoEvento = new Date("2023 Oct 15 14:00:00");
    /*Definindo data do evento*/ const timeStampDoEvento = dataDoEvento.getTime(); /*Coletando timeStamp do evento*/ 
    const timer = document.getElementById("contador");
    /*Coletando o local do timer no HTML*/ setInterval(function() {
        let dataDeHoje = new Date();
        /*Coletando a data do dia atual*/ let timeStampDeHoje = dataDeHoje.getTime(); /*Coletando o timeStamp do dia atual*/ 
...
},{}]},["e11Rl","gLLPy"], "gLLPy", "parcelRequireb2fa")
